...
public class BLStats {
 ...
 public static void main(String[] args) {
	...
	System.out.println("   max %10.3f\n", max(a));
        System.out.println("    min %10.3f\n", min(a));
        System.out.println("   mean %10.3f\n", mean(a));
        System.out.println("  stddev %10.3f\n", stddev(a));
        System.out.println("    var %10.3f\n", var(a));
    }
}
